    ...
    public String getReport(String reportName) throws Exception{
        ...
        switch(reportName){
            ...
            case RP_SCHEDULE_ERRORS:
                report = new ScheduleErrorsReport();
                break;
            case RP_HOME:
                return getIndexPage();
            default:
...
class ScheduleErrorsReport extends AbstractReport{
...
class ScheduleReport2 extends AbstractReport{
    Dataset hall_list,day_list,bell_list,depart,schedule;
...
class ScheduleReport extends AbstractReport{
    Dataset day_list,bell_list,hall_list,schedule,depart;
...
class CurriculumReport extends AbstractReport{
    ...
    private static final String SQL_SKILS = 
            "select distinct a.id,a.caption \n"+
    ...
    private static final String SQL_SUBJECTS = 
            "select distinct a.id,a.subject_name \n" +
